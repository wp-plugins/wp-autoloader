...
WordPress Autoloader helps ot make life of WP developers a lot easier. This plugin loads automatically PHP classes. No need to wrote include scripts anymore. WP Autoloader provides also a set of tools for plugin developers. Create plugins with few lines of code now.
