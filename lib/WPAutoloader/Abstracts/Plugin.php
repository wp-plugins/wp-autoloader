...
abstract class Plugin implements iPlugin {
	...
	final protected static function GetHookFile() {
		# Seek triuugh debig trace and get plugin path
	...
	public static function AddAdminStyleSheet( $handle, $src = null, $deps = array(), $ver = false, $media = 'all' ) {
		...
		$class::AddAdminNotice( 'Version of <a href="' . $class::GetPluginURI() . '" target="_blank">' . $class::GetName() . '</a> is outdated. Please upgrade the plugin.', true );
	}
